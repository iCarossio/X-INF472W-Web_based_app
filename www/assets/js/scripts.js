...
jQuery(function ($) {
    ...
    // More skill
    // -------------------------------------------------------------
    $('.communication').bind('inview', function(event, visible, visiblePartX, visiblePartY) {
        if (visible) {
            $('.chart').easyPieChart({
    ...
    /*
    (function () {
        var myLatlng = new google.maps.LatLng(48.714403, 2.211302);
            ...
            var contentString = 'École polytechnique';
